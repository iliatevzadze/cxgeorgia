...
test("required workspace keys exist in both locales", () => {
  const requiredWorkspaceKeys = [
    ...
    "workspaces.app.cases.slaStatusLabel",
    "workspaces.app.cases.notSet",
    "workspaces.app.cases.slaStatusOptions.on_track",
    "workspaces.app.cases.slaStatusOptions.at_risk",
    "workspaces.app.cases.slaStatusOptions.breached",
    "workspaces.app.cases.filtersLabel",
    "workspaces.app.cases.filterCases",
    "workspaces.app.cases.allStatuses",
    ...
    "workspaces.app.cases.assignedUserLabel",
    "workspaces.app.cases.allAssignees",
    "workspaces.app.cases.assigneesLoadError",
    "workspaces.app.cases.clearFilters",
    "workspaces.app.cases.totalCasesLabel",
    ...
    "workspaces.app.cases.create.selectCustomer",
    "workspaces.app.cases.create.noCustomer",
    "workspaces.app.cases.create.customersLoading",
    "workspaces.app.cases.create.customersLoadError",
    ...
    "workspaces.app.cases.detail.linkedCustomerTitle",
    "workspaces.app.cases.detail.linkedCustomerLabel",
    "workspaces.app.cases.detail.noCustomerLinked",
    "workspaces.app.cases.detail.customerLabel",
    "workspaces.app.cases.detail.selectCustomer",
    "workspaces.app.cases.detail.noCustomer",
    "workspaces.app.cases.detail.changeCustomer",
    "workspaces.app.cases.detail.unlinkCustomer",
    "workspaces.app.cases.detail.customersLoading",
    "workspaces.app.cases.detail.customersLoadError",
    "workspaces.app.cases.detail.customerLinkSuccess",
    "workspaces.app.cases.detail.customerLinkError",
    "workspaces.app.cases.detail.customerLinkNoChanges",
    "workspaces.app.cases.detail.customerLinkSaving",
    "workspaces.app.cases.detail.customerLinkSave",
    "workspaces.app.cases.detail.slaTitle",
    "workspaces.app.cases.detail.slaStatusLabel",
    "workspaces.app.cases.detail.firstResponseDueLabel",
    "workspaces.app.cases.detail.firstResponseAtLabel",
    "workspaces.app.cases.detail.resolutionDueLabel",
    "workspaces.app.cases.detail.resolvedAtLabel",
    "workspaces.app.cases.detail.notSet",
    "workspaces.app.cases.detail.slaStatusOptions.on_track",
    "workspaces.app.cases.detail.slaStatusOptions.at_risk",
    "workspaces.app.cases.detail.slaStatusOptions.breached",
    ...
    "workspaces.app.cases.detail.qaReviewsTitle",
    "workspaces.app.cases.detail.qaReviewsEmpty",
    "workspaces.app.cases.detail.qaReviewsLoading",
    "workspaces.app.cases.detail.qaReviewsLoadError",
    "workspaces.app.cases.detail.qaReviewCreateTitle",
    "workspaces.app.cases.detail.qaReviewCreateButton",
    "workspaces.app.cases.detail.qaReviewCreating",
    "workspaces.app.cases.detail.qaReviewAgentLabel",
    "workspaces.app.cases.detail.qaReviewAgentPlaceholder",
    "workspaces.app.cases.detail.qaReviewAgentRequired",
    "workspaces.app.cases.detail.qaReviewOverallCommentLabel",
    "workspaces.app.cases.detail.qaCriteriaAddTitle",
    "workspaces.app.cases.detail.qaCriteriaAddButton",
    "workspaces.app.cases.detail.qaCriteriaAdding",
    "workspaces.app.cases.detail.qaCriterionNameLabel",
    "workspaces.app.cases.detail.qaCriterionNameRequired",
    "workspaces.app.cases.detail.qaScoreLabel",
    "workspaces.app.cases.detail.qaScoreValidationError",
    "workspaces.app.cases.detail.qaCommentLabel",
    "workspaces.app.cases.detail.qaApproveButton",
    "workspaces.app.cases.detail.qaRejectButton",
    "workspaces.app.cases.detail.qaReviewStatusLabel",
    "workspaces.app.cases.detail.qaReviewerLabel",
    "workspaces.app.cases.detail.qaReviewSaveError",
    "workspaces.app.cases.detail.qaReviewUpdateError",
    "workspaces.app.cases.detail.qaReviewValidationError",
    "workspaces.app.cases.detail.qaReviewUpdating",
    "workspaces.app.cases.detail.qaStatusOptions.pending",
    "workspaces.app.cases.detail.qaStatusOptions.approved",
    "workspaces.app.cases.detail.qaStatusOptions.rejected",
    "workspaces.app.cases.detail.attachmentsTitle",
    "workspaces.app.cases.detail.attachmentsLoading",
    "workspaces.app.cases.detail.attachmentsLoadError",
    "workspaces.app.cases.detail.attachmentsEmpty",
    "workspaces.app.cases.detail.attachmentUploadTitle",
    "workspaces.app.cases.detail.attachmentChooseFile",
    "workspaces.app.cases.detail.attachmentSelectedFile",
    "workspaces.app.cases.detail.attachmentFileName",
    "workspaces.app.cases.detail.attachmentContentType",
    "workspaces.app.cases.detail.attachmentFileSize",
    "workspaces.app.cases.detail.attachmentUploadedAt",
    "workspaces.app.cases.detail.attachmentUploadButton",
    "workspaces.app.cases.detail.attachmentUploading",
    "workspaces.app.cases.detail.attachmentUploadError",
    "workspaces.app.cases.detail.attachmentDeleteButton",
    "workspaces.app.cases.detail.attachmentDeleting",
    "workspaces.app.cases.detail.attachmentDeleteError",
    ...
    "workspaces.app.home.notBuiltIntegrations",
    "workspaces.app.dashboard.title",
    "workspaces.app.dashboard.description",
    "workspaces.app.dashboard.loading",
    "workspaces.app.dashboard.error",
    "workspaces.app.dashboard.empty",
    "workspaces.app.dashboard.sections.cases",
    "workspaces.app.dashboard.sections.sla",
    "workspaces.app.dashboard.sections.agents",
    "workspaces.app.dashboard.sections.qa",
    "workspaces.app.dashboard.metrics.total",
    "workspaces.app.dashboard.metrics.open",
    "workspaces.app.dashboard.metrics.pending",
    "workspaces.app.dashboard.metrics.resolved",
    "workspaces.app.dashboard.metrics.onTrack",
    "workspaces.app.dashboard.metrics.atRisk",
    "workspaces.app.dashboard.metrics.breached",
    "workspaces.app.dashboard.metrics.activeShifts",
    "workspaces.app.dashboard.metrics.agentCaseMetrics",
    "workspaces.app.dashboard.metrics.agentMessages",
    "workspaces.app.dashboard.metrics.totalReviews",
    "workspaces.app.dashboard.metrics.approved",
    "workspaces.app.dashboard.metrics.rejected",
    "workspaces.app.dashboard.metrics.averageScore",
    "workspaces.app.workforce.title",
    "workspaces.app.workforce.loading",
    "workspaces.app.workforce.error",
    "workspaces.app.workforce.shiftUpdateError",
    "workspaces.app.workforce.myShift",
    "workspaces.app.workforce.shiftStatusLabel",
    "workspaces.app.workforce.activeShift",
    "workspaces.app.workforce.noActiveShift",
    "workspaces.app.workforce.clockIn",
    "workspaces.app.workforce.clockOut",
    "workspaces.app.workforce.clockingIn",
    "workspaces.app.workforce.clockingOut",
    "workspaces.app.workforce.clockInAtLabel",
    "workspaces.app.workforce.activeShifts",
    "workspaces.app.workforce.noActiveShifts",
    "workspaces.app.workforce.caseMetrics",
    "workspaces.app.workforce.noCaseMetrics",
    "workspaces.app.workforce.userId",
    "workspaces.app.workforce.caseId",
    "workspaces.app.workforce.assignedAt",
    "workspaces.app.workforce.firstResponseAt",
    "workspaces.app.workforce.resolvedAt",
    "workspaces.app.workforce.messagesCount",
    "workspaces.app.workforce.filterUserId",
    "workspaces.app.workforce.filterCaseId",
    "workspaces.app.workforce.applyFilters",
    "workspaces.app.workforce.noValue",
    "workspaces.app.customers.title",
    "workspaces.app.customers.loading",
    "workspaces.app.customers.detailLoading",
    "workspaces.app.customers.error",
    "workspaces.app.customers.empty",
    "workspaces.app.customers.searchLabel",
    "workspaces.app.customers.applySearch",
    "workspaces.app.customers.statusLabel",
    "workspaces.app.customers.statusAll",
    "workspaces.app.customers.statusActive",
    "workspaces.app.customers.statusArchived",
    "workspaces.app.customers.createTitle",
    "workspaces.app.customers.createButton",
    "workspaces.app.customers.creating",
    "workspaces.app.customers.editTitle",
    "workspaces.app.customers.displayName",
    "workspaces.app.customers.displayNameRequired",
    "workspaces.app.customers.email",
    "workspaces.app.customers.phone",
    "workspaces.app.customers.externalId",
    "workspaces.app.customers.locale",
    "workspaces.app.customers.notes",
    "workspaces.app.customers.saveButton",
    "workspaces.app.customers.saving",
    "workspaces.app.customers.saveError",
    "workspaces.app.customers.deleteButton",
    "workspaces.app.customers.deleting",
    "workspaces.app.customers.deleteError",
    "workspaces.app.customers.createdAtLabel",
    "workspaces.app.customers.noValue",
    "workspaces.app.customers.caseHistoryTitle",
    "workspaces.app.customers.linkedCasesTitle",
    "workspaces.app.customers.noLinkedCases",
    "workspaces.app.customers.caseHistoryLoading",
    "workspaces.app.customers.caseHistoryError",
    "workspaces.app.customers.caseStatusLabel",
    "workspaces.app.customers.casePriorityLabel",
    "workspaces.app.customers.caseSourceLabel",
    "workspaces.app.customers.caseCreatedAtLabel",
